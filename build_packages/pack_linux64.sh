...
# Move to dist
mv ./build_packages/linux64/packages/*.rpm "./dist/txt2gam-$RELEASE_VER-linux64.rpm"
mv ./build_packages/linux64/packages/*.deb "./dist/txt2gam-$RELEASE_VER-linux64.deb"
mv ./build_packages/linux64/packages/*.tar.gz "./dist/txt2gam-$RELEASE_VER-linux64.tar.gz"
